...
This skill is _informed_ by the project's domain model — `CONTEXT.md` and any `context/adr/`. The domain language gives names to good seams; ADRs record decisions the skill should not re-litigate. See [CONTEXT-FORMAT.md](../domain-model/CONTEXT-FORMAT.md) and [ADR-FORMAT.md](../domain-model/ADR-FORMAT.md).
...
- Relevant ADRs in `context/adr/` (and any context-scoped `context/adr/` directories)

...
.PHONY: help setup sync dev backend frontend agent-browser-ready agent-browser-check agent-shot agent-browser-cleanup typography-eval db db-up db-down db-wait db-reset db-reset-dev \
        ...
        backup-drill-local smoke seed-dev-user seed-agent-user seed-agent-browser seed-agent-mcp smoke-mcp-local seed-perf-stress seed-climate-bundle seed-dev-data seed-materials seed-glazing seed-frames seed-hbjson db-seed e2e e2e-perf e2e-report clean
...
# or the path does not exist yet.

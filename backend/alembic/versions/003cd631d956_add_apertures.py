...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_aperture_glazing_types_id"),
        "aperture_glazing_types",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["frame_type_id"],
            ["aperture_frame_types.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_aperture_element_frame_id"),
        "aperture_element_frame",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["glazing_type_id"],
            ["aperture_glazing_types.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_aperture_element_glazing_id"),
        "aperture_element_glazing",
        ["id"],
        unique=False,
    )

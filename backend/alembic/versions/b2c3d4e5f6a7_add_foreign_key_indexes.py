...
def upgrade() -> None:
    ...
    op.create_index("ix_assembly_layers_assembly_id", "assembly_layers", ["assembly_id"])
    ...
    op.create_index("ix_material_datasheets_segment_id", "material_datasheets", ["segment_id"])

    # AirTable Tables table
    op.create_index("ix_airtable_tables_parent_base_id", "airtable_tables", ["parent_base_id"])

    # Apertures table
    op.create_index("ix_apertures_project_id", "apertures", ["project_id"])

    # Aperture Elements table
    op.create_index("ix_aperture_elements_aperture_id", "aperture_elements", ["aperture_id"])
    op.create_index("ix_aperture_elements_glazing_id", "aperture_elements", ["glazing_id"])
    op.create_index("ix_aperture_elements_frame_top_id", "aperture_elements", ["frame_top_id"])
    op.create_index("ix_aperture_elements_frame_bottom_id", "aperture_elements", ["frame_bottom_id"])
    op.create_index("ix_aperture_elements_frame_left_id", "aperture_elements", ["frame_left_id"])
    op.create_index("ix_aperture_elements_frame_right_id", "aperture_elements", ["frame_right_id"])
...
def downgrade() -> None:
    ...
    # Aperture Element Frame table
    op.drop_index("ix_aperture_element_frame_frame_type_id", table_name="aperture_element_frame")
    ...
    op.drop_index("ix_aperture_elements_frame_bottom_id", table_name="aperture_elements")
    ...
    # Assembly Layer Segments table
    op.drop_index("ix_assembly_layer_segments_material_id", table_name="assembly_layer_segments")
    op.drop_index("ix_assembly_layer_segments_layer_id", table_name="assembly_layer_segments")

...
class Aperture(Base):
    ...
    row_heights_mm: Mapped[list[float]] = MappedColumn(Float, default=100, nullable=False)
    column_widths_mm: Mapped[list[float]] = MappedColumn(Float, default=100, nullable=False)

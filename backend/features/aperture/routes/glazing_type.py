...
def get_glazing_types_route(
    ...
    logger.info("aperture/get_glazing_types_route()")
...
def refresh_db_glazing_types_from_air_table_route(
    ...
    logger.info("assembly/refresh_db_glazing_types_from_air_table_route()")
...
def load_all_glazing_types_from_airtable_route(
    ...
    """Return all of the glazing types in the database."""
    logger.info("assembly/load_all_glazing_types_from_airtable_route()")

    glazing_types = get_all_glazing_types_from_airtable()
    return [
        GlazingTypeSchema.model_validate(glazing_type) for glazing_type in glazing_types
    ]

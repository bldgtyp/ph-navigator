...
def create_material(payload: CatalogMaterialCreateRequest, user: UserPublic, request: Request) -> CatalogMaterialPublic:
    ...
    with transaction() as conn:
        repository.insert_material(
            ...
            air_permeance_l_s_m2_at_75pa=payload.air_permeance_l_s_m2_at_75pa,
            vapor_diffusion_resistance_mu=payload.vapor_diffusion_resistance_mu,
            vapor_sd_equivalent_m=payload.vapor_sd_equivalent_m,
            color=payload.color,
...
def duplicate_material(material_id: str, user: UserPublic, request: Request) -> CatalogMaterialPublic:
    ...
    with transaction() as conn:
        ...
        repository.insert_material(
            ...
            air_permeance_l_s_m2_at_75pa=source["air_permeance_l_s_m2_at_75pa"],
            vapor_diffusion_resistance_mu=source["vapor_diffusion_resistance_mu"],
            vapor_sd_equivalent_m=source["vapor_sd_equivalent_m"],
            color=source["color"],

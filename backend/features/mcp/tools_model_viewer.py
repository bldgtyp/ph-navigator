"""MCP tools for Model tab HBJSON file management (US-VIEW-1 crit. 14).

Upload-intent and complete-upload are asset-level concerns already covered
by the generic asset tools; these five cover the viewer metadata lifecycle
so an agent can manage HBJSON uploads end to end.
"""

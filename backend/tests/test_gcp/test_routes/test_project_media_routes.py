...
def test_get_project_media_urls_empty_project(
...
def test_get_project_media_urls_with_photos(
    client: TestClient, session: Session, create_test_project
):
    ...
    assert (
        data["site_photos"][str(segment.id)][0]["thumbnail_url"]
        == "https://storage.example.com/thumb1.jpg"
    )


def test_get_project_media_urls_with_datasheets(
    client: TestClient, session: Session, create_test_project
):
    ...
    assert (
        data["datasheets"][str(segment.id)][0]["thumbnail_url"]
        == "https://storage.example.com/thumb_ds1.jpg"
    )


def test_get_project_media_urls_with_mixed_media(
    client: TestClient, session: Session, create_test_project
):
...
def test_get_project_media_urls_project_not_found(
    client: TestClient, session: Session, create_test_project
):

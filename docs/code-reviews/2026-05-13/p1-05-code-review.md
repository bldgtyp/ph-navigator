...
RELATED:
  - docs/plans/01_IMPLEMENTATION-ROADMAP.md (P1-05 row + ledger)
  - docs/plans/2026-05-13/phase-1-full-buildout-plan.md
  - docs/code-reviews/2026-05-13/p1-04-code-review.md (preceding slice)
...
| `docs/plans/01_IMPLEMENTATION-ROADMAP.md` | Modified | P1-05 status `[~] In progress` + ledger row. |

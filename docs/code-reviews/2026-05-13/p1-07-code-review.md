...
RELATED:
  - docs/plans/01_IMPLEMENTATION-ROADMAP.md (P1-07 row + ledger)
  - docs/plans/2026-05-13/phase-1-full-buildout-plan.md (P1-07 slice)
  - docs/plans/2026-05-13/phase-1-baseline-gap-matrix.md (G-10, G-11)
  - docs/code-reviews/2026-05-13/p1-06-code-review.md (preceding slice)

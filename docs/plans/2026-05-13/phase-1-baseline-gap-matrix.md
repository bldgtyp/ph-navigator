...
| G-09 | Status full MVP | Backend CRUD/template and local e2e edit/reorder/delete/viewer pass; full story still calls for drag reorder, keyboard fallback, sanitized Markdown preview/edit polish, shadcn delete dialog, current-step visual verification, and MCP-callable status posture review. | Now | P1-06 |

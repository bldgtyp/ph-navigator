...
const COLUMN_DEFS: DataTableColumnDef<MaterialRow>[] = [
  ...
  {
    id: "vapor_diffusion_resistance_mu",
    fieldKey: "vapor_diffusion_resistance_mu",
    header: "Vapor Resistance",
    accessor: (row) => row.vapor_diffusion_resistance_mu,
    className: "numeric-cell",
    defaultWidth: 150,
  },
  {
    id: "vapor_sd_equivalent_m",
    fieldKey: "vapor_sd_equivalent_m",
    header: "Vapor sd",
    accessor: (row) => row.vapor_sd_equivalent_m,
    className: "numeric-cell",
    defaultWidth: 125,
  },
  {

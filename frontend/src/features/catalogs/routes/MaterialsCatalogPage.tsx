...
export function MaterialsCatalogPage({ session }: { session: AuthSession }) {
  ...
  const renderBody = (): ReactNode => {
    ...
    return (
      <div className="materials-catalog-table-wrapper">
        <table className="materials-catalog-table">
          ...
          <tbody>
            {items.map((material) => (
              <tr
                key={material.id}
                className={material.is_active ? "" : "materials-catalog-row-inactive"}
              >
                <td>{material.name}</td>
                ...
                <td>
                  <div className="materials-catalog-row-actions">
                    <button
                      type="button"
  ...
  return (
    <main className="workspace-shell">
      ...
      />
      <section className="dashboard-page" aria-labelledby="materials-catalog-title">
        <div className="page-heading">
          <div>
            <p className="eyebrow">Catalogs</p>
            <h1 id="materials-catalog-title">Materials</h1>
            <p className="materials-catalog-description">
        ...
        <div className="materials-catalog-toolbar">
          <label className="materials-catalog-inactive-toggle">
            <input
              type="checkbox"
          ...
          <span className="materials-catalog-count">

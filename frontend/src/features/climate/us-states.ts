// US state/territory codes for the dataset-picker state filter. The reference
// datasets store `region` as a 2-letter state code, so the picker offers the
// full list (plus DC) and lets the backend filter. US-first, matching the
// climate features' scope.

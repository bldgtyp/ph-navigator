...
export function indoorEquipFieldDefs(options: HeatPumpsSlice["single_select_options"]): FieldDef[] {
  ...
  return [
    ...
    heatPumpNumberField("cooling_cap_kw", "Cooling Capacity"),
    heatPumpNumberField("heating_cap_kw_47f", "Heating Capacity at 47F"),
    heatPumpNumberField("heating_cap_kw_17f", "Heating Capacity at 17F"),
    ...
    heatPumpAttachmentField(INDOOR_EQUIP_PHOTO_FIELD_KEY, "photo"),
    incomingIndoorUnitsFieldDef(),
...
export function indoorEquipColumnDefs({
  ...
  return [
    ...
    number("cooling_cap_kw", "Cooling Capacity", 160),

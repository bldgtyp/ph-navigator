...
import { Button, ButtonGroup, Dialog, DialogActions, DialogContent, DialogTitle, Divider, TextField } from "@mui/material";
        ...
        <Dialog open={props.isModalOpen} onClose={props.handleModalClose}>
            ...
            <form onSubmit={handleFormSubmit}>
                <DialogContent>
                    ...
                    <FormField label="Building Type Project Number" name="bt_number" value={formData.bt_number} onChange={handleInputChange} />
                    <FormField label="PHIUS Project Number" name="phius_number" value={formData.phius_number} onChange={handleInputChange} />
                    <FormField label="PHIUS Dropbox URL" name="phius_dropbox_url" value={formData.phius_dropbox_url} onChange={handleInputChange} />
                </DialogContent>

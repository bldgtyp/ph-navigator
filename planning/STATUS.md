...
| DataTable Formula Builder | Active / Phases 01-05 implemented for shared formula editor UI, structured error cards, `&` concat grammar, autocomplete, and all-table formula regression coverage; Phase 06 closeout is next | `features/data-table-formula-builder/STATUS.md` |

...
| --- | --- | --- | --- | --- |
| Desktop catalog read | Feature (cross-repo) | **Merged to `main`** via [#91](https://github.com/bldgtyp/ph-navigator/pull/91) (2026-09-09); production deploy with migration `20260909_0014` and the real extension sign-in remain Ed's call, then archive | [#90](https://github.com/bldgtyp/ph-navigator/issues/90) | [`features/desktop-catalog-read/`](features/desktop-catalog-read/STATUS.md) |
...
| HBJSON import of honeybee `Model` files | Feature (cross-repo) | **Implemented on branch** `feature/hbjson-import-honeybee-models` (2026-09-10); D1–D3 accepted, gates green, merge/PR pending Ed | [#92](https://github.com/bldgtyp/ph-navigator/issues/92) | [`features/hbjson-import-honeybee-models/`](features/hbjson-import-honeybee-models/STATUS.md) |

...
| --- | --- | --- | --- | --- |
| Desktop catalog read | Feature (cross-repo) | **In review** on `feature/desktop-catalog-read`; database verification blocked by sandbox TCP restrictions | [#90](https://github.com/bldgtyp/ph-navigator/issues/90) | [`features/desktop-catalog-read/`](features/desktop-catalog-read/STATUS.md) |

...
| Documentation Page Redesign | In progress / Phase 02 complete: schema v7 persists Datasheet+Photo status and the Documentation page now uses an overview-first section/group/record disclosure shell; Phase 03 axis selects and evidence writes are next | `refactor/documentation-page-redesign/STATUS.md` |

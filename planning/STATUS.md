...
| --- | --- | --- | --- | --- |
| Desktop window catalog read | Feature (cross-repo) | **Merged to `main`** via [#97](https://github.com/bldgtyp/ph-navigator/pull/97) (2026-09-14); production deploy (no migration, Ed's call) and the SketchUp phase-8f production walkthrough remain, then archive | [#96](https://github.com/bldgtyp/ph-navigator/issues/96) | [`features/desktop-window-catalog-read/`](features/desktop-window-catalog-read/STATUS.md) |

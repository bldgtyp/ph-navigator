...
| DataTable Formula Builder | Active / Phase 01 shared formula editor UI complete; Phase 02 message/error cards next | `features/data-table-formula-builder/STATUS.md` |

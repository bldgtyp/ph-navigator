...
| DataTable UI | Active / Phase 00 route matrix and written baseline captured; Phase 01 numeric alignment and decimal precision investigation next | `features/data-table-ui/STATUS.md` |

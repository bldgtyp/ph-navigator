...
| DataTable Formula Builder | Active / Phases 01-04 implemented for shared formula editor UI, structured error cards, `&` concat grammar, and autocomplete; Phase 05 all-table regression coverage is next | `features/data-table-formula-builder/STATUS.md` |

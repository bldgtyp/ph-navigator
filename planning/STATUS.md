...
|---|---|---|
| DataTable Write Performance (refactor) | Active — Phases 00-05 complete: FIFO journals/coalescing, lineage-safe undo, honest counted conflicts, and three-way-gated one-shot retry; Phase 06 measurement gate next | `refactor/data-table-write-performance/STATUS.md` |

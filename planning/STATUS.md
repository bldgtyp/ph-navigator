...
|---|---|---|
| Beta Schema Evolution | Active / Phase 1 upgrade harness implemented on branch; Phase 2 golden corpus and regression tests next | `features/beta-schema-evolution/STATUS.md` |

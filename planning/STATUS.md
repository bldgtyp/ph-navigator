...
| Documentation Page Redesign | In progress / Phase 01 complete: schema v7 persists Datasheet+Photo status, v6 -> v7 backfills from waiver/attachments, rollups use status fields, uploads auto-complete; Phase 02 progressive disclosure shell is next | `refactor/documentation-page-redesign/STATUS.md` |

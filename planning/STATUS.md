...
|---|---|---|
| Beta Schema Evolution | Active / Phases 1-3 implemented on branch; Phase 4 FieldDef drift and schema-bump docs next | `features/beta-schema-evolution/STATUS.md` |

...
|---|---|---|
| DataTable Write Performance (refactor) | Active — Phases 00-01 complete: measured write path plus one FIFO lane per open draft with lifecycle flush/cancel; Phase 02 optimistic journals next | `refactor/data-table-write-performance/STATUS.md` |

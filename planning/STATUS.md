...
| Documentation Page Redesign | Planned / Option 1A overview-and-drill-down refactor packet drafted; Phase 00 decision recorded: Spec has Complete/Question/Needed/NA, Datasheet+Photo have persisted Complete/Needed/NA and upload auto-completes while manual Needed remains valid with attachments | `refactor/documentation-page-redesign/STATUS.md` |

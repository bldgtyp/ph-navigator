...
| Documentation Page Redesign | In progress / Phase 03 complete: Documentation rows now expose Spec, Datasheet, and Photo status-pill selects with expanded evidence upload/delete controls; Phase 04 visual polish and responsive checks are next | `refactor/documentation-page-redesign/STATUS.md` |

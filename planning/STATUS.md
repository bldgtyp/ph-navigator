...
|---|---|---|
| Status Dashboard | Complete / archived after compact draft/viewer summary API, bounded Record status disclosure, exact row focus links, quiet two-pane layout, progressive editor-only Roadmap controls, cold-load/accessibility E2E, Graphify, and full CI | `archive/dated/2026-07-10/status-dashboard/STATUS.md` |

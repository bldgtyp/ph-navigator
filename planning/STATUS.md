...
| MCP Write Loop | Active / Phase 1 implemented on `codex/mcp-write-loop` with `save_draft`, `discard_draft`, MCP lifecycle docs, and focused backend tests; Phase 2 `replace_table` wiring next | `features/mcp-write-loop/STATUS.md` |

...
| Apertures, Envelope, Climate + Tooltip UI Polish | Active / Phases 1-4 implemented on branch: shared Radix tooltip primitive, Save Version blocking overlay, Assembly canvas stroke gutter, and Climate map tile-loading spinner; Phase 5 Apertures zero-type empty-state cleanup next | `refactor/envelope-save-ui-polish/STATUS.md` |

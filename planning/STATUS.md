...
|---|---|---|
| DataTable Write Performance (refactor) | Active — Phase 00 observability/audit complete with 1,000-row baseline; Phase 01 draft write coordinator next | `refactor/data-table-write-performance/STATUS.md` |

...
|---|---|---|
| DataTable Write Performance (refactor) | Active — Phases 00-04 complete: draft FIFO, optimistic journals, coalescing, counted rollback, and 50-entry lineage-safe undo; Phase 05 conflict retry next | `refactor/data-table-write-performance/STATUS.md` |

...
| --- | --- | --- | --- | --- |
| Desktop window catalog read | Feature (cross-repo) | **Implemented on branch** `feature/desktop-window-catalog-read` (PR closes #96; `make ci` green 2026-09-14); merge, production deploy (no migration), and the SketchUp phase-8f production walkthrough remain, then archive | [#96](https://github.com/bldgtyp/ph-navigator/issues/96) | [`features/desktop-window-catalog-read/`](features/desktop-window-catalog-read/STATUS.md) |

...
| Apertures, Envelope, Climate + Tooltip UI Polish | Active / Phases 1-5 implemented on branch: shared Radix tooltip primitive, Save Version blocking overlay, Assembly canvas stroke gutter, Climate map tile-loading spinner, and Apertures zero-type empty-state cleanup; Phase 6 final verification next | `refactor/envelope-save-ui-polish/STATUS.md` |

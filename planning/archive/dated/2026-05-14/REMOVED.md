...
### `planning/archive/dated/project-versioning-predecessor.md`
...
### `planning/archive/dated/2026-05-11/draft-save-state-machine.md`
...
These are still active, but moved out of `planning/archive/dated/` and into
`context/`:

| Old path | New path |
|---|---|
| `planning/archive/dated/architecture-prd.md` | `context/PRD.md` |
| `planning/archive/dated/tech-stack.md` | `context/TECH_STACK.md` |
| `planning/archive/dated/table-view.md` | Removed 2026-05-12; current contract in `context/technical-requirements/data-table.md` |
| `planning/archive/dated/ui-ux.md` | `context/UI_UX.md` |
| `planning/archive/dated/user-stories.md` | `context/USER_STORIES.md` |

...
RESULT:
  ...
  - Phase 8 verification: `pnpm run check:all`, `make check-frontend`,
    ...
    all passed.
PARENT-DOC: planning/code-reviews/2026-05-25/frontend-code-review.md
SIBLING-DOC: planning/archive/dated/2026-05-25/plan-22-backend-refactor-phased.md
RELATED:
...
The frontend code-review at `planning/code-reviews/2026-05-25/frontend-code-review.md`
...
## Phase 2 — Extract `useSliceTableController` and split `EquipmentTab.tsx` *(execute 4th)* — ✅ COMPLETE (merged dd6dcc2)
...
- **File-size guard** (`frontend/scripts/check-file-sizes.mjs`):
  ...
  long; document in `planning/code-reviews/2026-05-25/frontend-code-review.md`
  §2.1).

...
STATUS: BACKEND COHORT LANDED 2026-05-26 — matrix extension, apply
        ...
        §P6 Phase 3;
        `planning/features/editable-fields/archive/complete/plan-31-phase-2-record-id-field.md`
        for the
        predecessor.
...
RELATED:
  - planning/features/editable-fields/PRD.md (master PRD, §P4.5, §P4.6)
  - planning/features/editable-fields/archive/complete/plan-31-phase-2-record-id-field.md (predecessor)

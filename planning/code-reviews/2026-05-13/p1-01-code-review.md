...
RELATED:
  - planning/ROADMAP.html (P1-01 row)
  - planning/archive/dated/2026-05-13/phase-1-full-buildout-plan.md (P1-01 scope)
...
| `planning/ROADMAP.html` | Modified | P1-01 status + lessons entry |

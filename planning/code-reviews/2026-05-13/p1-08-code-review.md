...
RELATED:
  - planning/ROADMAP.html (P1-08 row + ledger)
  - planning/archive/dated/2026-05-13/phase-1-full-buildout-plan.md (P1-08 slice)
  - planning/archive/dated/2026-05-13/phase-1-baseline-gap-matrix.md
  - planning/code-reviews/2026-05-13/p1-07-code-review.md (preceding slice)
...
| File | Status | Notes |
|---|---|---|
| `planning/ROADMAP.html` | Modified | Updates P1-08 row status + ledger row to "In progress / Shared extraction started; Rooms migrated to first shared read/copy/sort surface". |

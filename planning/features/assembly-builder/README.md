...
| 14 | `phase-14-to-scale-canvas-hover-controls.md` | UI parity: replace the scaffold canvas with a to-scale colored layer/segment drawing and compact hover/focus controls. | Canvas visually matches V1's core assembly drawing while preserving SI-canonical geometry and accessibility. |
...
| 14 | Proposed | To-scale canvas and hover-control parity plan added. No implementation yet. |

...
| ⛔ `assembly-membrane-layers` **Phases 1–2** | prerequisite — without membranes the engine computes a confident answer for a wall that doesn't exist. **Phases 1-2 landed 2026-07-26** (category + air permeance + R exclusion; hairline rendering + single-segment rule) — this prerequisite is now clear |

...
STATUS: BACKBONE LANDED (2026-05-26). Backend types/models reshaped,
        ...
        is tracked in
        `planning/features/editable-fields/archive/complete/plan-31-phase-1c-rename-cascade-and-fixtures.md`.
...
RELATED:
  - planning/features/editable-fields/PRD.md (master PRD, §P0.1, §P2.3, §P4.2)
  - planning/features/editable-fields/archive/complete/plan-31-phase-1a-lock-model.md (predecessor)

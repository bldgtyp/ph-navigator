...
RELATED:
  - planning/features/editable-fields/PRD.md (master PRD, §P4.3, §P5.1, §P5.2)
  - planning/features/editable-fields/archive/complete/plan-31-phase-1a-lock-model.md
  - planning/features/editable-fields/archive/complete/plan-31-phase-1b-persistence-reshape.md (predecessor)
  - planning/features/editable-fields/archive/complete/plan-30-datatable-identifier-column.md (superseded for identifier semantics)
...
- `context/UI_UX.md §1.7`: scrub references to the synthetic
  identifier.
- `planning/features/editable-fields/archive/complete/plan-30-datatable-identifier-column.md`
  STATUS header: mark superseded by Phase 2 (or move to
  `planning/archive/dated/2026-05-14/REMOVED.md` per the project convention).
...
10. `context/technical-requirements/data-table.md` Identifier Column
    ...
    `IdentifierConfig`.
11. `planning/features/editable-fields/archive/complete/plan-30-datatable-identifier-column.md`
    marked superseded.
...
- `planning/archive/dated/2026-05-14/REMOVED.md` should be updated to route any reader who

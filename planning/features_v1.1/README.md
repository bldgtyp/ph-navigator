...
| [Climate — Rain exposure class](climate-rain-exposure/README.md) | Deferred | Auto-derive a rain-exposure tier from annual rainfall + mean wind (EPW/ASHRAE) → cladding-strategy hint on the Climate tab. Best built on the EPW-metrics layer; gated on RX-1 (annual-rainfall source). Sourced to Straube BSD-018/013 + PNNL BASC/BEMMI. |

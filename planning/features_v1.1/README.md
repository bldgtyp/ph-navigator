...
| [Climate — PHI/PHPP importer](climate-phi-importer/README.md) | Deferred | Independent — the provider-agnostic seed seam is ready. Write `importers/phi.py` + validate the ~130-column workbook map. |
